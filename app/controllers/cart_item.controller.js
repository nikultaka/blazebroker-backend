...
exports.findAll = async(req, res) => {
  ...
  var query  = 'select p.*,ci.id as cart_id,ci.qty as cart_qty,ci.product as product,ci.session_id as uniqueID from cart_items  as ci left join products as p on p.id = ci.product_id where p.status = 1 AND ci.session_id = "'+req.body.session_id+'"';
